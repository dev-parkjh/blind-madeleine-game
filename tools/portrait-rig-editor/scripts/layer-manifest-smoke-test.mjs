...
assert.match(appJs, /kind: "portrait_rig_web_layer_manifest"/, "layer manifest export should identify its clean-room format");
...
assert.match(readme, /without using proprietary PSD or Portrait Rig formats/, "README should state the clean-room import boundary");
