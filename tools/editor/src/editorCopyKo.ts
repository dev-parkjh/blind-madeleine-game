...
export const koEditorCopy: EditorCopy = {
  ...
  form: {
    ...
    flipX: "좌우 반전",
    mystery: "수수께끼",
    live2dAutoPose: "Live2D 자동 포즈",
    live2dPoseHint: "Live2D 포즈 힌트",
    live2dPoseHintPreset: "포즈 힌트 프리셋",
    live2dPoseHintCustom: "포즈 힌트 직접 입력",
    live2dMotionLoop: "모션 루프",
    live2dDialogueMotion: "대화 반응 모션",
    live2dDialogueDefaults: "대화 모션 기본값",
    live2dSyncExports: "Live2D 내보내기 동기화",
    live2dMotionClip: "Live2D 모션",
    live2dIdleMotionClip: "대기 모션",
    live2dTalkMotionClip: "말하기 모션",
    live2dVisemeMotionClip: "입모양 모션",
    live2dMotionTime: "모션 시간",
    live2dMotionProgress: "모션 진행률",
    live2dMotionSpeed: "모션 속도",
    live2dMotionBlendDuration: "모션 전환",
    live2dMotionAutoCycle: "자동 순환",
    exit: "퇴장",
