...
export const enEditorCopy: EditorCopy = {
  ...
  form: {
    ...
    flipX: "Flip X",
    mystery: "Mystery",
    live2dAutoPose: "Live2D auto pose",
    live2dPoseHint: "Live2D pose hint",
    live2dPoseHintPreset: "Pose hint preset",
    live2dPoseHintCustom: "Custom pose hint",
    live2dMotionLoop: "Motion loop",
    live2dDialogueMotion: "Dialogue motion",
    live2dDialogueDefaults: "Dialogue defaults",
    live2dSyncExports: "Sync Live2D exports",
    live2dMotionClip: "Live2D motion",
    live2dIdleMotionClip: "Idle motion",
    live2dTalkMotionClip: "Talk motion",
    live2dVisemeMotionClip: "Viseme motion",
    live2dMotionTime: "Motion time",
    live2dMotionProgress: "Motion progress",
    live2dMotionSpeed: "Motion speed",
    live2dMotionBlendDuration: "Motion blend",
    live2dMotionAutoCycle: "Auto cycle",
    exit: "Exit",
