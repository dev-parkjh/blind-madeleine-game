...
const tagActions = [
  ...
  { label: "Portrait Rig 표정", hint: "portrait_rig_pose", category: "motion", insert: "[portrait_rig_pose tag=\"happy\"]" },
  { label: "Portrait Rig 모션", hint: "portrait_rig_motion", category: "motion", insert: "[portrait_rig_motion clip=\"idle_loop\" loop=true]" },
