...
assert.match(appJs, /kind: "live2d_web_project"/, "project bundle should identify its clean-room format");
...
assert.match(appJs, /\/live2d-part/, "project bundle import should re-upload embedded image parts");
